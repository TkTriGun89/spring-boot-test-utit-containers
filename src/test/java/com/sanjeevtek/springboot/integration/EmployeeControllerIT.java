...
import com.sanjeevtek.springboot.repository.EmployeeRepository;
...
public class EmployeeControllerIT extends AbstractContainerBaseTest {
    ...
    public void givenListOfEmployees_whenGetAllEmployees_thenReturnEmployeesList() throws Exception{
        ...
        listOfEmployees.add(Employee.builder().firstName("Sanjeev").lastName("Kumar S").email("Sanjeev@gmail.com").build());
